...
const categories = [
  ...
  },
  {
    ...
    articles: [
      ...
      {
        title: 'Nærøyfjord electric ferry: 2 hours through the world\'s narrowest UNESCO fjord',
        slug: 'naeroyfjord-electric-ferry-review',
        readTime: '8 min',
        status: 'published' as const,
      },
      {
        title: 'Flåm Railway: 866 meters in 55 minutes on one of the world\'s steepest standard-gauge lines',
        slug: 'flam-railway-myrdal-review',
        readTime: '9 min',
        status: 'published' as const,
      },
      {
        title: 'Kayaking Nærøyfjord from Gudvangen: what 250-meter walls look like at water level',
        slug: 'kayaking-naeroyfjord-guided-review',
        readTime: '9 min',
        status: 'published' as const,
      },
      {
        title: 'Rimstigen: 850 meters above Nærøyfjord on a medieval farmers\' path',
        slug: 'rimstigen-naeroyfjord-trail-report',
        readTime: '10 min',
        status: 'published' as const,
      },
      {
        title: 'Trolltunga from Skjeggedal: 27 km, 800 meters, and 30 minutes queuing for the photo',
        slug: 'trolltunga-skjeggedal-trip-report',
        readTime: '11 min',
        status: 'published' as const,
      },
      {
        title: 'Vøringsfossen: the two viewpoints, the valley floor, and arriving before the tour buses',
        slug: 'voringsfossen-mabodalen-guide',
        readTime: '8 min',
        status: 'published' as const,
      },
      {
        title: 'Hardanger cider trail in September: orchards, farmgates, and 50 producers in one weekend',
        slug: 'hardanger-cider-harvest-trail',
        readTime: '9 min',
        status: 'published' as const,
      },
      {
        title: 'Folgefonna glacier walk: crampons at 1,200 meters while the fjord is warm below',
        slug: 'folgefonna-glacier-walk-report',
        readTime: '9 min',
        status: 'published' as const,
      },
      {
        title: 'Driving the Rv55 Sognefjellet: the highest mountain pass road in Northern Europe',
        slug: 'sognefjellet-rv55-national-tourist-route',
        readTime: '10 min',
        status: 'published' as const,
      },
      {
        title: 'Urnes Stave Church: 900 years old and still standing above Lustrafjord',
        slug: 'urnes-stave-church-lustrafjord',
        readTime: '9 min',
        status: 'published' as const,
      },
      {
        title: 'Prest viewpoint above Flåm: the ridge hike that avoids the Stegastein crowd',
        slug: 'prest-viewpoint-flam-trail',
        readTime: '8 min',
        status: 'published' as const,
      },
      {
        title: 'Norway in a Nutshell from Bergen: the day trip that actually delivers',
        slug: 'norway-in-a-nutshell-bergen-review',
        readTime: '10 min',
        status: 'published' as const,
      },
      {
