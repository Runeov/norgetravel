...
export default function EditExperiencePage() {
        ...
        if (json.success && json.data) {
          ...
          if (matched) {
            setForm({
              ...
              experienceType: matched.experienceType || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/travel/experiences?id=${id}`, {
        method: 'PUT',
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Edit Experience</h1>
          <p className="text-slate-500 text-sm mt-0.5">
            Save Changes for a new experience listing for the travel map.
          </p>
        </div>
      </div>
