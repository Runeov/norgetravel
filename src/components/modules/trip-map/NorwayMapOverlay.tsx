      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4 lg:mb-6 shrink-0">
              <div>
                ...
                <p className="text-white/50 text-sm mt-1 hidden sm:block">
                  Four regions. Four entirely different Norways.
                </p>
              </div>
              <button
                ref={closeButtonRef}
            ...
            {/* Map + Info Panel */}
            <div className="flex-1 flex flex-col lg:flex-row gap-6 lg:gap-10 min-h-0 overflow-y-auto lg:overflow-visible">
              {/* Map */}
