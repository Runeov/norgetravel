  ...
  const serviceItems: FeatureTabItem[] = [
    {
      ...
      content: 'Solar Cycle 25 peaks in 2026 — making this the most intense aurora decade in over a century. We connect you with professional Tromsø guides who guarantee the best possible conditions.',
      bullets: ['Photography-focused small groups', 'G3+ geomagnetic storm alerts', 'GetYourGuide & Viator certified', '7% – 10% affiliate commissions'],
